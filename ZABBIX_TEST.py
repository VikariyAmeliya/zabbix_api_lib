...
class API:
    ...
    def __init__(self, url=None, token=None, user=None, password=None, creds_file=None):
        """
        Args:
            url (str, optional): URL Zabbix API
            token (str, optional): API токен
            user (str, optional): Имя пользователя Zabbix
            password (str, optional): Пароль Zabbix
            creds_file (str, optional): Путь к .ini файлу с кредами
        """
        creds = None
        if creds_file:
            creds = ConfigParser()
    ...
    def _connect(self):
        """
        Внутренний метод для установки соединения и аутентификации.
        """
        try:
            ...
            # Небольшая проверка, что API живой (запросим версию)
    ...
    def get_usermacro(self, hosts):
        ...
        if not isinstance(hosts, list):
            try:
                ...
                print("Ошибка: hosts должен быть списком")
                return {}
    ...
    def get_problem(self, hosts):
        ...
        if isinstance(hosts, str):
            ...
            try:
                ...
                print("Ошибка: hosts должен быть списком или строкой")
                return {}
